...
begin
  case idx of
    ...
    2: begin
      query.SQL.Text := 'SELECT TRAINS.TRAIN_ID, TRAINS.DEPARTURE_DATE, PASSENGERS.NUMBER_OF_TICKETS, PASSENGERS.POINT_OF_DEPARTURE, ' +
      'PASSENGERS.POINT_OF_DESTINATION, BAGGAGE.BAGGAGE_AMOUNT FROM PASSENGERS INNER JOIN TRAINS ON TRAINS.TRAIN_ID=PASSENGERS.TRAIN_ID ' +
      'INNER JOIN BAGGAGE ON BAGGAGE.PASSENGER_ID=PASSENGERS.PASSENGER_ID WHERE PASSENGERS.PASSENGER_NAME=:passengerName';
